...
const Dashboard = () => {
  ...
  return (
    !loading && (
      <div className="bg-bgColor2 w-full h-screen flex flex-col px-4 lg:px-16 xl:px-64 overflow-scroll">
        ...
        <div className="flex flex-col items-center lg:flex-row lg:space-x-10 mt-6 pb-4">
          ...
          <section className="grid grid-cols-1 gap-5 basis-2/3 max-w-xl w-full">
