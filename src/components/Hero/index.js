...
const Hero = () => {
  return (
    <div className="h-full bg-blue-700 py-10">
      {/* display bar */}
      <div className="xl:w-3/4 xl:h-[600px] mx-auto overflow-y-scroll py-3 px-3 bg-white rounded-[20px] mb-4">
        {/* display search data */}
      </div>

      {/* search bar */}
      <div className="xl:w-3/4 relative mx-auto rounded-xl py-3 px-4 space-x-2">
        {/* blur backgrund */}
        <div
        ...
        <div className="z-10 relative flex items-center justify-between space-x-4 px-2 py-3 bg-white rounded-lg">
          {/* button */}
          <button
            className="flex items-center space-x-2 py-3 px-2 font-raleway font-bold text-base text-white rounded-lg"
            style={{
              background:
          ...
          >
            Categories
            <img src={Chevron} alt="down" className="ml-2" />
          </button>
