...
const CoursesSection = () => {
  return (
    <div className="flex flex-col px-64 items-center">
      <h1 className="text-4xl text-blue4 font-inter font-semibold mb-10">
        Courses
      </h1>
      ...
      {/* button */}
      <button
        className="rounded-[90px] border-none text-white text-base font-raleway font-bold w-max px-10 py-3"
        style={{
          background:
